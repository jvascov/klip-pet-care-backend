...
public interface OwnerController {
    ...
    @PostMapping("/owner")
    ResponseEntity<CustomResponse> create(@RequestBody OwnerRequestDTO ownerDTO, BindingResult result) throws ControllerException, NotContentException, ServiceException;

    /*@Operation(summary = "Update owner by document")
    @ApiResponses(value = {
    ...
    @PatchMapping("/owner/{document}")
    ResponseEntity<CustomResponse> update(@RequestBody OwnerRequestDTO ownerDTO) throws ControllerException, NotContentException;
*/
}
